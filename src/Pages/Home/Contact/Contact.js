    ...
    return (
        <div>
            ...
            <section className="py-6 bg-gray-800 text-gray-50">
                <div className="max-w-6xl rounded-3xl grid gap-8 px-6 py-12 mx-auto lg:grid-cols-3 bg-white">
                    <div>
                    ...
                    <div className="grid grid-cols-1 gap-12 lg:col-span-2 sm:grid-cols-2 ">
                        <div className="p-4 rounded-lg bg-blue-50 md:p-6 dark:bg-gray-800">
                            ...
                            <p className="mt-2 text-sm text-blue-500 dark:text-blue-400">herorider@gmail.com</p>
                        </div>
                        ...
                        <div className="p-4 rounded-lg bg-blue-50 md:p-6 dark:bg-gray-800">
                            ...
                            <p className="mt-2 text-sm text-blue-500 dark:text-blue-400">Dhaka, Bangladesh</p>
                        </div>
                        ...
                        <div className="p-4 rounded-lg bg-blue-50 md:p-6 dark:bg-gray-800">
                            ...
                            <p className="mt-2 text-sm text-blue-500 dark:text-blue-400">++(880)1954057920</p>
                        </div>
                    </div>
                </div>
            </section>
