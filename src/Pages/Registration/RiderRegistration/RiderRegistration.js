...
const RiderRegistration = () => {
    ...
    const onSubmit = data => {
        ...
        if (password === confirmPassword) {
            ...
            toast.error("Pasword dosn't match")
            setError("Pasword dosn't match")
        }
    }
    ...
    return (
        <div>
            <ScrollToTop />
            <section className="max-w-4xl p-6 mx-auto bg-green-50  rounded-md shadow-md dark:bg-gray-800 my-11">
                <h2 className="text-lg font-semibold text-gray-700 capitalize dark:text-white text-center mb-7 px-5 py-3 bg-blue-500 w-64 mx-auto text-white">Rider Sign Up</h2>
                ...
                <form onSubmit={handleSubmit(onSubmit)} className='flex items-start flex-col lg:flex-row gap-7 '>
                    <div className='max-w-md'>
                        <div>
                            <div>
                                ...
                                <div className='mt-4'>
                                    <label className="block text-sm text-gray-500 dark:text-gray-300">Area</label>
                                    <input type="text" className="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border-2 border-gray-200 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring"
                                        {...register("area")}
                                    />
                                </div>
                                ...
                                <div className='flex items-center gap-5 mt-4 flex-col md:flex-row w-full'>
                                    <div className='w-full'>
                                        <label className="block text-sm text-gray-500 dark:text-gray-300" >Car Name</label>
                                        <input type="text" className="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border-2 border-gray-200 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring"
                                            {...register("carName")}
                                        />
                                    </div>
                                    <div className='mt- md:mt-0 w-full'>
                                        <label className="block text-sm text-gray-500 dark:text-gray-300" >Model Number</label>
                                        <input type="text" className="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border-2 border-gray-200 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring"
                                            {...register("model")}
                                        />
                                    </div>
                                ...
                                <div className='mt-4 '>
                                    <label className="block text-sm text-gray-500 dark:text-gray-300" for="emailAddress">Name Palate</label>
                                    <input type="text" className="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border-2 border-gray-200 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring"
                                        {...register("namePalate")}
                                    />
                                </div>
                    ...
                    <div className='flex-1 '>
                        <div>
                            <label for="image" className="block text-sm text-gray-500 dark:text-gray-300">Driving Licence</label>
