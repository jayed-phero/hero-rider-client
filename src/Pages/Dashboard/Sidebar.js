            ...
            >
                ...
                <div class="flex flex-col justify-between flex-1 mt-6">
                    <nav class="flex-1 -mx-3 space-y-3 ">
                        ...
                        <Link onClick={() => setActive(!isActive)} to='/dashboard/paymentsinfo' class="flex items-center px-3 py-2 text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700" >
                            <i class="fa-solid fa-money-check-dollar text-xl"></i>

                            <span class="mx-2 text-sm font-medium">Payments Info</span>
                        </Link>
