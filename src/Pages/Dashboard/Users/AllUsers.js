...
const AllUsers = () => {
    ...
    const [till, setTill] = useState(35)
    ...
    const getAllUser = () => {
        axios.get(`${process.env.REACT_APP_API_URL}/alluser?page=${page}&size=${size}&search=${search}`)
            .then(res => {
                console.log(res)
            ...
            <section class="container px-4 mx-auto">
                <div class="sm:flex sm:items-center sm:justify-between">
                    ...
                    <div class="flex items-center mt-4 gap-x-3">
                        <div class="flex items-center justify-between w-1/2 text-sm text-gray-700 transition-colors duration-200 bg-white rounded-lg gap-x-2 sm:w-auto dark:hover:bg-gray-800 dark:bg-gray-900 hover:bg-gray-100 dark:text-gray-200 dark:border-gray-700">
                            <input type="text" placeholder="From" class=" placeholder-gray-400/70 dark:placeholder-gray-500 rounded-lg border-2 border-gray-200 bg-white px-2 py-2 text-gray-700 focus:border-blue-400 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-40 dark:border-gray-600 dark:bg-gray-900 dark:text-gray-300 dark:focus:border-blue-300 w-16" />
                            <h3>To</h3>
                            <input type="text" placeholder="Till" class="placeholder-gray-400/70 dark:placeholder-gray-500 rounded-lg border-2 border-gray-200 bg-white px-2 py-2 text-gray-700 focus:border-blue-400 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-40 dark:border-gray-600 dark:bg-gray-900 dark:text-gray-300 dark:focus:border-blue-300 w-16" />
                ...
                <div class="mt-6 md:flex md:items-center md:justify-between">
                    ...
                    <div class="relative flex items-center mt-4 md:mt-0">
                        ...
                        <input ref={serarchRef} onChange={handleSearch} type="text" placeholder="Search" class="block w-full py-1.5 pr-5 text-gray-700 bg-white border border-gray-200 rounded-lg md:w-80 placeholder-gray-400/70 pl-11 rtl:pr-11 rtl:pl-5 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 dark:focus:border-blue-300 focus:ring-blue-300 focus:outline-none focus:ring focus:ring-opacity-40" />
                    </div>
                </div>
