...
const RowOfService = ({ service }) => {
    ...
    return (
        <div>
            <div className="w-full max-w-sm px-4 py-3  rounded-md shadow-md bg-gray-800">
                <div className="flex items-center justify-between">
                    <span className="text-sm font-light text-gray-400">Offers & Bounes</span>
                    <span className="px-3 py-1 text-xs  uppercase rounded-full bg-blue-300 text-blue-900">{sortName}</span>
                </div>
                ...
                <div>
                    <div className="flex items-center mt-2 text-gray-200">
                        <span>Visit on:</span>
                        <a className="mx-2  cursor-pointer text-blue-400 hover:underline" tabindex="0" role="link">hero.org</a>
                        <span>or</span>
                        <a className="mx-2 cursor-pointer text-blue-400 hover:underline" tabindex="0" role="link">herorider.com</a>
                    </div>

                    <div className="flex items-center justify-center mt-4">
                        <a className="mr-2  cursor-pointer text-gray-400 hover:text-gray-700 dark:hover:text-gray-300" tabindex="0" role="link" aria-label="twitter link">
                        ...
                        <a className="mr-2 cursor-pointer text-gray-400 hover:text-gray-700 hover:text-gray-300" tabindex="0" role="link" aria-label="share link">
